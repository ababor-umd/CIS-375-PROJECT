...
public:
     ...
     //generate shortsrt path based on distance
     void foundShortestPathBasedOnDistance(int source, int destination);

     //call foundShortestPathBasedOnDistance method with source and destination value 
     void pathRecommendationBasedOnDistance();

     void foundCheapestPathBasedOnCost(int source, int destination);


     void flightPathRecommenderBasedOnCost();
